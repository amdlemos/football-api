...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'football.api_key' => 'string',
            'football.cache_duration' => 'string',
            'football.cache' => 'boolean',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','football.api_key',
'football.cache_duration','football.cache','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key',
...
'livewire.inject_morph_markers','livewire.pagination_theme','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver',
...
'VITE_APP_NAME','FOOTBALL_CACHE','FOOTBALL_DATA_API_KEY','FOOTBALL_CACHE_DURATION','SAIL_XDEBUG_MODE',);
