...
'queue.failed.table','saloon.default_sender','saloon.integrations_path','services.postmark.token','services.ses.key',
...
'livewire.preview-file','competitions.index','competitions.index','competition.index',
'competition.matches','dashboard','profile.edit','profile.update','profile.destroy',
...
'VITE_APP_NAME','FOOTBALL_DATA_API_KEY','SAIL_XDEBUG_MODE',);
